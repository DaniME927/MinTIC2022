 ...
 * @author Usuario
 */
public class MascotaConstuctorEncapsulamientFuncionClass {
    ...
    public MascotaConstuctorEncapsulamientFuncionClass(String nombre_mascota, String fecha_nacimiento, String raza, boolean vacunas, boolean historial_clinico, int nro_documento_dueño) {
    ...
    public String consultar_informacion_mascota_funcion() {
        ...
        if (isVacunas() == true) {
            validar_vacunacion = getNombre_mascota() + " si está vacunado";
        } else {
            validar_vacunacion = getNombre_mascota() + " no está vacunado";
        }
        ...
        return "    Nombre: " + getNombre_mascota() + "\n    Raza: " + getRaza()
                ...
                + "\n    Nro de documento: " + getNro_documento_dueño()
                + "\n    " + validar_vacunacion + "\n    " + historial_clinico;
    }
    ...
    public void consultar_informacion_mascota_metodo() {
        ...
        System.out.println("\nFORMA III: Encapsulamiento, constructor y método que imprime"
                + " los GETTER de las variables:\n*******MÉTODO*******\n    Nombre: " + getNombre_mascota() + "\n    Raza: " + getRaza()
                + "\n    Fecha de nacimiento: " + getFecha_nacimiento()
                + "\n    Nro de documento: " + getNro_documento_dueño()
                + "\n    " + validar_vacunacion + "\n    " + historial_clinico); 
    }
